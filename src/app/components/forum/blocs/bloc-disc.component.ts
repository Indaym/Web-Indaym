...
@Component({
  ...
  <div class="discussion-item">
    ...
    <div class="discussion-title-all">
      <span class="discussion-title-tag"><i class="fa fa-comment"></i></span>
      <a href="#">
      <span class="discussion-title">lorem ipsum (discussion)</span>
    </a>
    </div>
  ...
  `,
  styleUrls    : ['app/components/forum/forum.css']
})
